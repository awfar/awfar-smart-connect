...
const UserFormEnhanced = ({ userId, isEditing = false, onSave }: UserFormEnhancedProps) => {
    ...
    <div className="space-y-6 pb-2">
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="grid w-full grid-cols-2">
          <TabsTrigger value="details">معلومات المستخدم</TabsTrigger>
          <TabsTrigger value="roles">الدور والصلاحيات</TabsTrigger>
        </TabsList>
          ...
          <div className="space-y-6 py-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                يحدد القسم الوحدات التي يمكن للمستخدم الوصول إليها في النظام
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                يؤثر الفريق على نطاق رؤية المستخدم للبيانات حسب صلاحياته
              </p>
            </div>
          </div>
        </TabsContent>
